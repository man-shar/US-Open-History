$(window).scroll(function() {
  ...
  if((svg_position_left - ($($(".titles-wrapper")[0])).outerWidth()) * 1.1 <= body_position && (svg_position_right - ($($(".titles-wrapper")[0])).outerWidth()) >= body_position) {
...
$(document).on("touchmove", function() {
  ...
  if((svg_position_left - ($($(".titles-wrapper")[0])).outerWidth()) <= body_position && (svg_position_right - ($($(".titles-wrapper")[0])).outerWidth()) >= body_position) {
    d3.select("#legend-container").style("display", "block");
  }
  else {
    d3.select("#legend-container").style("display", "none");
